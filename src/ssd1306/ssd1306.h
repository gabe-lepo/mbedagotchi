...
// Controls if display is "mirrored" (COL0 for normal left>right)
...
#define SSD1306_COM_PIN_CONFIG_ALTERNATING 0x12
...
#define SSD1306_PRECHARGE_INIT 0xF1
...
#define SSD1306_VCOMH_DESELECT_077_VCC 0x20 // 2.541V
